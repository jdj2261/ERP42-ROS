...
public:
    ...
    virtual void CalculateOdometry(const double &delta_time);
    virtual void ResetOdometry();
    //  // Set new odometry.
    virtual void SetOdometry(const double &new_x, const double &new_y, const double &new_yaw);
    virtual void SetParams(const double &wheel_diameter,
