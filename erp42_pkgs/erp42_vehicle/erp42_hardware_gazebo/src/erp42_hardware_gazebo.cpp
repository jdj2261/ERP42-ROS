...
#include <erp42_hardware_gazebo/erp42_hardware_gazebo.h>

namespace erp42_hardware_gazebo
{
  using namespace hardware_interface;

  ERP42HardwareGazebo::ERP42HardwareGazebo()
    : gazebo_ros_control::RobotHWSim()
    , ns_("erp42_hardware_gazebo/")
    , log_cnt_(0)
  {}


  bool ERP42HardwareGazebo::initSim(const std::string& robot_namespace,
      ros::NodeHandle nh,
  ...
  void ERP42HardwareGazebo::readSim(ros::Time time, ros::Duration period)
  {
  ...
  void ERP42HardwareGazebo::writeSim(ros::Time time, ros::Duration period)
  {
  ...
  void ERP42HardwareGazebo::CleanUp()
  {
    // wheel
    //-- wheel joint names
  ...
  void ERP42HardwareGazebo::GetJointNames(ros::NodeHandle &_nh)
  {
    this->GetWheelJointNames(_nh);
    this->GetSteerJointNames(_nh);
  }

  void ERP42HardwareGazebo::GetWheelJointNames(ros::NodeHandle &_nh)
  {
  ...
  void ERP42HardwareGazebo::GetSteerJointNames(ros::NodeHandle &_nh)
  {
  ...
  void ERP42HardwareGazebo::RegisterHardwareInterfaces()
  {
  ...
  void ERP42HardwareGazebo::RegisterInterfaceHandles(
  ...
  void ERP42HardwareGazebo::RegisterWheelInterface()
  {
    // actual wheel joints
  ...
  void ERP42HardwareGazebo::RegisterSteerInterface()
  {
    // actual steer joints
    this->RegisterInterfaceHandles(
  ...
  void ERP42HardwareGazebo::RegisterJointStateInterfaceHandle(
      hardware_interface::JointStateInterface& _jnt_state_interface,
      const std::string _jnt_name, double& _jnt_pos, double& _jnt_vel, double& _jnt_eff)
  {
  ...
  void ERP42HardwareGazebo::RegisterCommandJointInterfaceHandle(
      hardware_interface::JointStateInterface& _jnt_state_interface,
      hardware_interface::JointCommandInterface& _jnt_cmd_interface,
  ...
  double ERP42HardwareGazebo::ComputeEffCommandFromVelError(
  ...
  void ERP42HardwareGazebo::GetCurrentState(std::vector<double>& _jnt_pos, std::vector<double>& _jnt_vel, std::vector<double>& _jnt_eff,
...
PLUGINLIB_EXPORT_CLASS(erp42_hardware_gazebo::ERP42HardwareGazebo, gazebo_ros_control::RobotHWSim)
